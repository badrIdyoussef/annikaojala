    ...
    return function(a, b, c, d) {
                    ...
                    if (y.State.calls[f]) {
                        ...
                        for (var v = Math.min(t / j.duration, 1), w = 0, x = i.length; w < x; w++) {
                            ...
                            if (g(B)) {
                                ...
                                j.mobileHA && g(B).transformCache.translate3d === d && (g(B).transformCache.translate3d = "(0px, 0px, 0px)", D = !0),
        ...
        function n(a, b) {
            ...
            for (var c = y.State.calls[a][0], e = y.State.calls[a][1], f = y.State.calls[a][2], h = y.State.calls[a][4], i = !1, j = 0, k = c.length; j < k; j++) {
                ...
                h && !0 !== f.loop && h(e),
                m && !0 === f.loop && !b && (o.each(m.tweensContainer, function(a, b) {
        ...
        var B = function() {
            ...
            function e(a, e) {
                function f(f) {
                    ...
                    if ("scroll" === G) {
                        ...
                        k = g(a),
                        k && k.tweensContainer && !0 === k.isAnimating && (n = k.tweensContainer);
                        var H = function(e, f) {
                            var g,
                                l = A.Hooks.getRoot(e),
                                m = !1,
            ...
            case "stop":
                o.each(r, function(a, b) {
                    ...
                    "finishAll" !== s || !0 !== v && !u.isString(v) || (o.each(o.queue(b, u.isString(v) ? v : ""), function(a, b) {
                        u.isFunction(b) && b()
                ...
                if (!o.isPlainObject(s) || u.isEmptyObject(s)) {
                    if (u.isString(s) && y.Redirects[s]) {
                        ...
                        return !0 === j.backwards && (r = o.extend(!0, [], r).reverse()), o.each(r, function(a, b) {
                            ...
                            j.drag && (j.duration = parseFloat(J) || (/^(callout|transition)/.test(s) ? 1e3 : w), j.duration = Math.max(j.duration * (j.backwards ? 1 - a / C : (a + 1) / C), .75 * j.duration, 200)),
